...
var CONFIG_DIR, PORT, SUFFIXES, async, express, forward, fs, handle, httpServer, readConfig, ref, request, serve, server, staticMiddlewares;
...
PORT = (ref = process.env.PORT) != null ? ref : 8080;
